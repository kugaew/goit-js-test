...
console.table(historyService.getEmails()); //возвращает массив всех уникальных почтовых адресов из свойства orders
console.table(historyService.getOrdersByEmail('solomon@topmail.net')); //возвращает[{ email: "solomon@topmail.net", dish: "Burger" }, { email: "solomon@topmail.net", dish: "Apple pie" }]
console.table(historyService.getOrdersByEmail('artemis@coldmail.net')); //возвращает [{ email: "artemis@coldmail.net", dish: "Pizza" }] */
